...
MongoDB.prototype.updateOrCreate = function updateOrCreate(
  ...
  if (self.settings.hasOwnProperty('collation')) {
    mongoQueryOptions.collation = self.settings.collation;
  }
  ...
  this.execute(
    ...
    data,
    buildOptions(mongoQueryOptions, options),
    function(err, result) {
      if (self.debug) {
...
MongoDB.prototype.destroyAll = function destroyAll(
  ...
  this.execute(modelName, 'deleteMany', where || {}, buildOptions(mongoQueryOptions, options), function(err, info) {
...
MongoDB.prototype.count = function count(modelName, where, options, callback) {
  ...
  options = buildOptions(mongoQueryOptions, options);
